...
class SchoolBusListCard extends StatelessWidget {
  ...
  const SchoolBusListCard({super.key, required this.bus, required this.onTap});
        ...
        child: Row(
          children: [
            Container(
              ...
              height: 44,
              decoration: BoxDecoration(
                color: AppColors.schoolGreenBg,
                borderRadius: BorderRadius.circular(10),
              ),
              child: const Icon(Icons.school_rounded, color: AppColors.schoolGreen, size: 22),
            ),
